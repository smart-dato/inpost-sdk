...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/InPost SDK.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/InPost SDK)
...
```bash
php artisan vendor:publish --tag="inpost-sdk-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="inpost-sdk-views"
```

## Usage

```php
$inPost = new Smartdato\InPost();
echo $inPost->echoPhrase('Hello, Smartdato!');
```
